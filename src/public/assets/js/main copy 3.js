...
let preguntas = false;
let contenidoInicio = '';
//contenidoInicio += '<div class="container-inicio">';
contenidoInicio += '<button class="boton-inicio" value="jugar">Jugar</button>';
contenidoInicio += '<button class="boton-inicio" value="ranking">Ranking</button>';
contenidoInicio += '<button class="boton-inicio" value="login">LOGIN</button>">';
...
contenidoInicial.classList.add('container-inicio');
containerMain.appendChild(contenidoInicial);
contenidoInicial.innerHTML('contenidoInicio');

//contenidoInicio += '</div>';
containerMain.innerHTML = contenidoInicio;
